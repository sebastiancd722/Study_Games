...
import { Flashcard, GameStatus, GridCell, GameState } from '../../types';
...
export const MemoryGame: React.FC<MemoryGameProps> = ({ cards, onExit }) => {
  ...
  useEffect(() => {
    // Take up to 8 pairs for a 4x4 grid
    const playCards = cards.slice(0, 8);
